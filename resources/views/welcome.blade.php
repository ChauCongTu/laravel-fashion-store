                        ...
                        <div class="block2 bg-white p-2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="{{ route('product.show', ['slug' => $product->slug, 'id' => $product->id]) }}" class="fw-bold cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        {{ $product->name }}
                                    </a>
                                ...
                                <div class="block2-txt-child2 flex-r p-t-3">
                                    <a href="{{ route('product.show', ['slug' => $product->slug, 'id' => $product->id]) }}" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                ...
                @foreach ($products as $product)
                    <div
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="{{ route('product.show', ['slug' => $product->slug, 'id' => $product->id]) }}" class="cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        {{ $product->name }}
                                    </a>
